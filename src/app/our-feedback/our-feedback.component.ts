...
export class OurFeedbackComponent implements OnInit {
  reviews = [
    {
      ...
      text: 'Регулярно заказываем у вас бумажные пакеты. Всегда радуют - отличное качество, оперативная доставка и приятные цены. Ребята, спасибо вам за отличную работу, удачи и процветания',
    ...
    },
    {
      ...
      text: 'Работаем с компанией уже несколько лет и можем отметить самые главные качества компании:<br/>профессионализм, выполнение поставленных задач, качество продукции, сроки изготовления и все это по очень выгодным ценам. Даже самые сложные идеи для рекламных материалов, команда Smart Pockets без проблем реализовывала в поставленные сроки. Со всей ответственностью рекомендуем.',
      name:
  ...
  slideConfig = { slidesToShow: 3, slidesToScroll: 3, dots: true, arrows: false, responsive: [
    {
      breakpoint: 950,
      settings: {
        slidesToShow: 2,
